...
class DynamicAgent(Agent):
    ...
    """
    def __init__(self, load=None, preset_dir='/opt/NanoLLM/nano_llm/agents/presets', **kwargs):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--agent-dir", type=str, default="/opt/NanoLLM/nano_llm/agents/presets", help="change the agent load/save directory")
